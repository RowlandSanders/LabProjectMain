 ...
 * conditions defined in the class invariant. If denominator is 0, 
 * then set it to 1.
 **************************************************************/
...
Fraction& Fraction::multiplyFract(const Fraction& ftest)
{
  Fraction curr(numer * ftest.numer, denom * ftest.denom);
  Fraction* currPtr = &curr;
  curr.normalize();
  return *currPtr;
}
